...
{
    /// <summary>
    /// Создаёт diagnostic для указанного <paramref name=""/> и добавляет его в коллекцию,
    ...
    /// <param name="">Результат расчёта индикатора. Не может быть <see langword="null"/>.</param>
    /// <exception cref="ArgumentNullException">
    /// Выбрасывается, если <paramref name="diagnostics"/> или <paramref name=""/> равны <see langword="null"/>.
    /// </exception>
