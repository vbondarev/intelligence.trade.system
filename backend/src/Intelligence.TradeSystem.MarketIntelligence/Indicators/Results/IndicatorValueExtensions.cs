...
public static class IndicatorValueExtensions
{
    ...
    /// <exception cref="ArgumentNullException">Выбрасывается, если <paramref name=""/> равен <see langword="null"/>.</exception>
    ...
    /// <exception cref="ArgumentNullException">Выбрасывается, если <paramref name=""/> равен <see langword="null"/>.</exception>
    /// <exception cref="InOperationException">Выбрасывается, если <see cref="IndicatorValue.IsAvailable"/> равен <see langword="false"/>.</exception>
    ...
    /// </remarks>
    /// <param name="">Результат расчёта индикатора. Может быть <see langword="null"/>.</param>
    /// <returns>
