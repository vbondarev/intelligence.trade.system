...
using Intelligence.TradeSystem.MarketIntelligence.Diagnostics;
using Intelligence.TradeSystem.MarketIntelligence.Indicators.Results;
using Xunit;

namespace Intelligence.TradeSystem.MarketIntelligence.Tests.Diagnostics;

public sealed class IndicatorDiagnosticListExtensionsTests
{
    // ── Normal   — no entry added ───────────────────────────────
