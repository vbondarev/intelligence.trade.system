...
- 🟡 `IPrivateAccountProvider` и account-specific private adapter Bybit умеют читать баланс и позиции, но ещё не связаны с пользователем, хранилищем и синхронизацией.
