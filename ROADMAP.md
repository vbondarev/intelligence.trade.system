...
- ✅ Реализованы переходы `New`, `Updated`, `Increased`, `Reduced`, `Closed`, `Unknown`, `Stale` и `Recovered`, а также безопасная сверка снимков.
...
| B-04 | Реализовать переходы позиции | ✅ | Проверены New, Updated, Increased, Reduced, Closed, Unknown, Stale и Recovered |
...
| 8 | Добавить пользовательский REST API и SignalR | F-01 — F-11 |
| 9 | Создать адаптивную React-панель | G-01 — G-08 |
| 10 | Добавить фоновые циклы наблюдения | H-01 — H-07 |
