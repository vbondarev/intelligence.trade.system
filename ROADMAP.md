...
Проверенная база: `develop` на коммите [`4a2bb28`](https://github.com/vbondarev/intelligence.trade.system/commit/4a2bb288895a090c6d708aa3cdc3a04b18662d0f) после завершения D-02
Последний учтённый PR: [#79 «#78: реализовал ручную синхронизацию аккаунта Bybit»](https://github.com/vbondarev/intelligence.trade.system/pull/79)
Текущий следующий этап: **D-04 — идемпотентность и защита от ответов не по порядку**
...
Статус этапа: 🟡 Подключение, ручная синхронизация и безопасное stale/unknown-согласование реализованы; идемпотентность и фоновая синхронизация остаются впереди.
