...
Проверенная база: `develop` на коммите [`d60264a`](https://github.com/vbondarev/intelligence.trade.system/commit/d60264a04e568f91d2f4019c585f59c397bd71d8) после завершения D-01
Последний учтённый PR: [#77 «#75: реализовал подключение и отключение аккаунта Bybit только для чтения»](https://github.com/vbondarev/intelligence.trade.system/pull/77)
Текущий следующий этап: **D-03 — согласование состояния с биржей и безопасная обработка stale/unknown**
...
Статус этапа: 🟡 Подключение и ручная синхронизация реализованы; stale/unknown и фоновая синхронизация остаются впереди.
