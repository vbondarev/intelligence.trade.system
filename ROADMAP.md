...
Статус этапа: 🟡 Частично реализован (PR E.1: E-01 — E-03; hard safety часть E-09; сценарная часть E-10).
...
| E-09 | Запретить повышение риска при устаревших, неполных или неопределённых данных | 🟡 | E.1 реализует неотключаемый hard guard для risk increase; запрет сильных recommendation actions будет завершён вместе с `RecommendationPolicy`/`RecommendedAction` в E.2 |
