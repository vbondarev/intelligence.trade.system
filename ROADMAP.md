...
Последний учтённый PR: #84 «Реализовал фоновую синхронизацию активных аккаунтов Bybit» (PR #85)
...
| D | Подключение Bybit и синхронизация | 🟡 D-01 — D-05 реализованы; D-06 и D-07 впереди |
...
Статус этапа: 🟡 D-01 — D-05 реализованы; D-06 и D-07 остаются впереди.
