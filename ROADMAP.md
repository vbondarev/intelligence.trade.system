...
Результат этапа: пользователь подключает Bybit с правами только на чтение; состояние баланса и позиций сохраняется и восстанавливается после перезапуска системы.
