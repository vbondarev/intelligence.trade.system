...
Этапы **A–F завершены**. Технические задачи Tech-G01 — Tech-G07 также завершены. Следующий обязательный шаг — G-01: основной React-клиент. Актуальная последовательность определяется `ROADMAP.md`.
