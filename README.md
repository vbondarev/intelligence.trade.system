...
8. **Для первого browser MVP выбран ASP.NET Core Identity с защищённой HttpOnly-cookie-сессией.** Реализация пользовательского входа и изоляции данных выполняется отдельными этапами.
...
1. аутентификация пользователей, изоляция данных и безопасное хранение ключей;
